...
.gallery-card video {
  ...
  object-fit: cover;
    ...
    .video-item video {
      ...
      height: 180px;
      border-radius: 12px;
      box-shadow: 0 0 15px cyan, 0 0 25px #00fff0;
    }
    .video-item p {
      margin-top: 5px;
      text-align: center;
...
<section id="guru">
  ...
  <div class="guru-grid">
    ...
    <div class="guru-card"><div class="guru-img"><img src="SUSI.JPG" alt="SUSI"></div><div class="guru-info"><h3>SUSI SUSILAWATI S.Pd</h3><p>GURU B. INODNESIA</p></div></div>
   ...
   <div class="guru-card"><div class="guru-img"><img src="DEDEN (2).jpg" alt="NUNUY"></div><div class="guru-info"><h3>NUNUY RATNAWULAN.S.Pd.,M.P </h3><p>GURU MATEMATIKA</p></div></div>
    ...
    <div class="guru-card"><div class="guru-img"><img src="GURU (2).JPG" alt="YOYO ROHAYA S.Pd"></div><div class="guru-info"><h3>YOYO ROHAYA S.Pd</h3><p>Guru</p></div></div>
    <div class="guru-card"><div class="guru-img"><img src="GURU (3).JPG" alt="DEDE SUMIATI S.Pd"></div><div class="guru-info"><h3>DEDE SUMIATI S.Pd</h3><p>Guru</p></div></div>
   <div class="guru-card"><div class="guru-img"><img src="tu (1).JPG" alt="SUSI"></div><div class="guru-info"><h3>Neni</h3><p>Guru</p></div></div>
...
<section id="galeri">
  ...
  <div class="gallery-scroll">
    ...
    <div class="gallery-card"><img src="galeri3.jpg" alt="Lomba Seni"></div>
    <div class="gallery-card"><img src="galeri4.jpg" alt="Kegiatan Eskul"></div>
    <div class="gallery-card"><img src="galeri5.jpg" alt="Belajar di Kelas"></div>
  ...
  <section id="video-selection">
    ...
    <div class="media-container">
      ...
      <div class="video-item"><video controls src="video2.mp4"></video><p>Keterangan: Pelajaran Matematika</p></div>
      <div class="video-item"><video controls src="video3.mp4"></video><p>Keterangan: Pelajaran IPA</p></div>
      <div class="video-item"><video controls src="video4.mp4"></video><p>Keterangan: Ekstrakurikuler PMR</p></div>
      <div class="video-item"><video controls src="video5.mp4"></video><p>Keterangan: English Club</p></div>
      <div class="video-item"><video controls src="video6.mp4"></video><p>Keterangan: Kegiatan Robotik</p></div>
